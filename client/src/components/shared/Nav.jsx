...
return (
  ...
  <Link to="/" className="navbar-brand">YHS</Link>
    ...
    <ul className="navbar-nav mr-auto">
      ...
      <li className="nav-item">
       ...
       <li className="nav-item dropdown">
         <a href="" className="nav-link dropdown-togle" id="resourcesDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Stories
         </a>
